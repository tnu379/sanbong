...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <form action="{{route('yard_store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <!-- Card -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" id="productNameLabel"
                                    placeholder="Name" aria-label="Shirt, t-shirts, etc.">
                            </div>
                            <!-- End Form Group -->
                        </div>
                        <!-- Body -->
            ...
            <input type="submit" style="width: 110px;" class="btn btn-primary">
        </form>
    </div>
    </div>
@endsection

...
@section('content')
    ...
    <div class="content container-fluid">
        <!-- Step Form -->
        <form class="js-step-form py-md-5" action="{{ route('user_store') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="address" id="organizationLabel"
                                            placeholder="1127/5" aria-label="1127/5">
                                    </div>
                                </div>
                                <!-- End Form Group -->
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="ward" id="departmentLabel"
                                            placeholder="Vạn Thạnh" aria-label="Vạn Thạnh">
                                    </div>
                                </div>
                                <!-- End Form Group -->
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="Street" id="departmentLabel"
                                            placeholder="2/4" aria-label="2/4">
                                    </div>
                                </div>
                                <!-- End Form Group -->
                                <div class="row form-group">
